...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String appTitle = 'My First App';
    return MaterialApp(
      title: appTitle,
      home: Scaffold(
        appBar: AppBar(
        ...
        body: const SingleChildScrollView(
          child: Column(
            children: [
              ...
              TextSection(
                description:
                'Telaga Sarangan adalah danau alami di kawasan pegunungan.'
                    'Tempat wisata ini cocok dikunjungi bersama keluarga. '
                    'Selain murah, Telaga Sarangan memiliki pemandangan menakjubkan '
                    'dan banyak aktivitas menarik yang bisa dilakukan. '
